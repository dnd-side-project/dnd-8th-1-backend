...
public class ReviewController {
  ...
  public ResponseEntity<DataResponse<ReviewInfoDto>> createReview(@RequestBody ReviewContentDto contentDto,
      @AuthenticationPrincipal SessionUser user) {
    ReviewInfoDto reviewInfoDto = reviewSaveComplexService.saveReview(contentDto, user.getId());
    return new ResponseEntity<>(DataResponse.of(HttpStatus.CREATED, "리뷰가 성공적으로 등록되었습니다.", reviewInfoDto),
        HttpStatus.CREATED);
  }
